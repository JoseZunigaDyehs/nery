        ...
        <div class="row mb-5 d-none" id="cheques">
            ...
            <div class="sec-pri p-3 w-100 d-flex">
              ...
              <div class="form-group col-md-4">
                  ...
                  <input id="monto" type="text" class="form-control" placeholder="Monto cheque" onkeyup="valTexto(this,4,50)"/>
                      <label class="error text-danger d-none position-absolute"></label>
                  </label>
              </div>
              <div class="d-flex align-items-center">
                <a class="btn btn-primary crear cursor-pointer" onclick="guardarCheque(this)" data-toggle="tooltip" data-placement="top" title="Guardar cheque">
